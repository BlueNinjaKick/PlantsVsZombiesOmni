...
int Sexy::SOUND_ENDERMAN_TELEPORT;
...
bool Sexy::ExtractLoadingSoundsResources(ResourceManager *theManager)
{
	...
	try
	{
		...
		SOUND_ENDERMAN_TELEPORT = aMgr.GetSoundThrow("SOUND_ENDERMAN_TELEPORT");
...
const char* Sexy::GetStringIdById(int theId)
{
	switch(theId)
	{
		...
		case SOUND_ENDERMAN_TELEPORT_ID: return "SOUND_ENDERMAN_TELEPORT";
